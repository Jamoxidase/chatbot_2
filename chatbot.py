...
class PlanningAgent:
    ...
    def _get_planning_system_prompt(self) -> str:
        ...
        IMPORTANT: Be sure not to confuse the current user prompt with the prompt history.
...
class ToolManager:
    def __init__(self, rna_central_tool, alignment_tool):
        self.tools = {
...
class TwoAgentChatbot:
    def __init__(self):
        ...
        self.tool_manager = ToolManager(
            rna_central_tool=rnaCentralTool(),
            alignment_tool=BasicAlignmentTool()
        )
...
if __name__ == "__main__":
    try:
        ...
        # Any cleanup code could go here if needed
        pass